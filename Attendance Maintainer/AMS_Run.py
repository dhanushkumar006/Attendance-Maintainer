...
window = tk.Tk()
window.title("FAMS-Attendance Maintainer")
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'D:/New folder (2)/Attendance Maintainer/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r"explorer /select,\"D:\New folder (2)\Attendance Maintainer\Attendance\Manually Attendance\-------Check atttendance-------\"")
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'D:New folder (2)/Attendance Maintainer/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"D:\New folder (2)\Attendance Maintainer\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'Kumar':
            if password == 'Kumar123':
                ...
                cs = 'D:/New folder (2)/Attendance Maintainer/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
